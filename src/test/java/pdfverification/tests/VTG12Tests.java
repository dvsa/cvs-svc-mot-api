...
public class VTG12Tests {
    ...
    private static final String NOTIFICATION_OF_FAILURE_TO_COMPLY = "Vehicle for Examination (VTG12)";
    ...
    private static final String REASONS_FOR_REFUSAL_LINE2 = "Reason 2 exists";
