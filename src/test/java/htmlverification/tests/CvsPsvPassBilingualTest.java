...
//        assertEquals(testCertificate.getData().getFormattedCurrentOdometer(), mileage2);
    ...
    public void verifyRecallsWelsh() {
        String titleText = certificatePageObjectVTP20W.getElement(".recalls__content-header").text();
        String contentText = certificatePageObjectVTP20W.getElement(".recalls__content-text").text();
